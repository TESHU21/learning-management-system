...
export default function CourseDetail() {
  ...
  useEffect(() => {
    ...
    const otherCourse = courses.filter(
      (course) => course._id !== selectedCourse._id,
    );
    ...
    <div className=" relative w-full">
      ...
      <div className="w-full md:h-[427px] bg-blue-primary text-white">
        ...
        <div className=" flex flex-col mt-10 px-4 md:px-[203px]">
          ...
          <p className="mb-6 mt-[21px] md:w-[556px] text-base font-inter text-justify ">
      ...
      <div className=" flex flex-col md:flex-row">
        ...
        <div className=" md:absolute md:top-[60px] md:right-[202px] md:w-[402px] bg-white">
          <div className="mx-[20px] mt-[10px]">
            <img
              src={openedCourse.image}
              alt=""
              className="w-[363px] h-[298px] object-cover"
            />
          </div>
          <div className="pt-[20px] w-[329px] mx-[35px]">
            ...
            <div className="px-6">
              <div className="flex  justify-between">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="leading-6 text-[16px]">Duration</span>
                </div>
                <span>12 weeks</span>
              </div>
              ...
              <div className="flex  justify-between">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="leading-6 text-[16px]">Courses</span>
                </div>
              ...
              <div className="flex  justify-between">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="leading-6 text-[16px]">Instructor</span>
                </div>
                <span>John Doe</span>
              </div>
              <hr className="my-[23px]" />
              <div className="flex  justify-between">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="leading-6 text-[16px]">Date</span>
                </div>
                <span>03/2025</span>
              </div>
              <hr className="my-[23px]" />
            ...
            <Button
              className=" w-full bg-blue-primary py-3 px-6  font-semibold hover:bg-blue-primary cursor-pointer"
              onClick={handleTrackEnrollment}
            >
              {isLoading ? <Loader /> : "Enroll"}
            </Button>
          </div>
        </div>
        ...
        <div className="md:ml-[200px] px-4 mt-[30px] py-10 mb-[34px] md:border border-[#E6E6E6] w-full md:w-[632px] md:pl-[11px] md:pt-[33px]">
          ...
          <div className="flex flex-col gap-3 pl-5">
            {core_concepts.map((item, index) => (
              <p
                key={index}
                className="flex gap-[10px]  items-baseline text-base w-full md:w-[578px] mt-2 leading-6"
              >
      ...
      <div className="md:mx-[200px] mx-6 mb-10 md:mb-[187px]">
        <p className=" font-semibold leading-[32px] text-[20px] px-4 text-start font-inter">
          Explore related courses
        </p>
        <div className=" grid grid-cols-1 md:grid-cols-2 justify-center  gap-2  md:mt-[62px]">
          {relatedCourse.map((item) => (
            <div
              key={item._id}
              className=" flex items-center gap-[10px] w-full md:w-[508px] p-6 shadow-lg shadow-black/15  rounded-lg cursor-pointer"
              onClick={() => handleRelatedCourseClick(item)}
            >
              <img
                src={item.image}
                alt=""
                className=" w-[100px] h-[109px] md:w-[202px]  md:h-[209.6px]  object-cover"
              />
              <div className=" flex flex-col  gap-4 mt-[40px] ">
                <p className=" font-semibold">{item.title}</p>
                <span className="leading-6 text-base text-justify">
