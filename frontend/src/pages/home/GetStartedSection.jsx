...
const GetStartedSection = () => {
  ...
  return (
    <div>
      ...
      <div
        className="  hidden md:flex relative  md:h-[222px] bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: `url(${LaptopWithCodeImage})`,
      ...
      >
        ...
        <div className=" flex absolute inset-0 pointer-events-none bg-[rgba(1,88,154,0.8)]">
          <div className="flex flex-col gap-2 ml-[198px] mt-[43px] text-white">
            <h3 className="font-lato font-bold text-[40px] leading-12">
              It’s time to start investing in yourself
            </h3>
            <p className=" text-base font-inter leading-6">
              Online courses open the opportunity for learning to almost anyone,
              regardless of their scheduling commitments.
            </p>
          </div>
          <Button
            className=" w-[137px]h-[137px] mt-[82px] ml-[37px] py-3 px-6 border border-white !bg-blue-primary hover:opacity-40 cursor-pointer pointer-events-auto"
              ...
              <div className="p-6 bg-white rounded-lg shadow-lg border">
                <div className="flex gap-4 md:gap-[30px]">
                  ...
                  <div className="flex flex-col gap-3">
                    <h5 className="font-bold font-lato leading-7">
                      {step.title}
                    </h5>
        ...
        <div className="hidden md:flex flex-col border shadow-lg rounded-md">
          <div className="flex pt-[63px] mx-[70px]">
            <div className="text-center">
              1 <br /> <span>Secure Login</span>
            </div>
            <div className="text-center ml-auto">
              2 <br /> <span>Authentication</span>
            </div>
          </div>
          ...
          <div className="mt-6 mx-[51px]">
            <div className="flex gap-7 justify-center">
              {solutions.map((item) => (
                <div
                  key={item.title}
                  className="p-6 border shadow-lg rounded-lg border-t-0"
                >
                  <div className="flex flex-col gap-2 w-[100.8px]">
                    <img
                      src={item.icon}
                      alt=""
                      className="w-[31.8px] h-[31.8px]"
                      loading="lazy"
                      decoding="async"
                    />
                    <p className="font-semibold text-[8px]">{item.title}</p>
                    <p className="text-[6.3px] leading-[9.44px]">
                      {item.description}
                    </p>
