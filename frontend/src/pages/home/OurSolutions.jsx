...
import IphoneImage from "../../assets/images/mockuuups-iphone-13-pro.webp";
import MicrosoftSurface from "../../assets/images/mockuuups-microsoft-surface-studio.webp";
    ...
    <div>
      ...
      <div className="flex flex-col px-[33px] pt-5 md:pt-[94px]  md:pb-[133px] md:px-[190px]  md:gap-14">
        <div className="flex flex-col gap-3">
          <h3 className="font-lato font-bold text-[24px] md:text-[40px] leading-12 text-center">
            Our solutions
          </h3>
          <p className="font-inter md:text-center leading-6 text-center">
        ...
        <div className="flex flex-col pt-[56px] md:flex-row gap-7 justify-center items-center  md:items-stretch mb-10 md:mb-0 ">
          {courses?.map((item) => (
            <div
              key={item.name}
              className="w-[325px] p-6 border shadow-lg rounded-lg border-t-0 flex flex-col justify-between"
            >
              <div className="flex flex-col gap-4 flex-grow">
                <img
                  src={item?.image}
                  alt=""
                  className="w-[86px] h-[86px] md:w-[81px] md:h-[81px]"
                />
              ...
              <div className="flex items-center justify-between mt-4">
                <p>${item.price}</p>
                <Button
                  className="bg-transparent shadow-none hover:bg-transparent text-blue-primary  cursor-pointer"
      ...
      <div className="flex px:[-14px] md:px-0 pt-8 bg-blue-primary h-[597px] md:h-[477px] rounded-md">
        <div className="flex-1 flex flex-col gap-9 md:pl-[199px]">
          <div className=" flex flex-col gap-3 px-5 md:px-0 md:w-[539px] text-white">
            <h3 className=" text-[40px] font-lato font-bold  leading-[1.2] ">
      ...
      <div className="hidden md:flex flex-col mt-[84px] pb-[95px]">
        ...
        <div className="px-[179px] flex flex-col gap-3 text-center">
          <h3 className="font-lato text-[40px] leading-12 font-bold">
            We are proud
          </h3>
          <p className="font-inter text-base leading-6">
        ...
        <div className="flex justify-center items-stretch gap-[120px] px-[276px] mt-[62px]">
          ...
          <div className="flex flex-col items-center justify-between text-center h-[184px]">
            <img
              src={StudentPersonIcon}
              alt="Student Person Icon"
              className="w-[80px] h-[80px]"
            />
            <h1 className="font-lato font-bold text-[60px] leading-[70px] text-blue-primary">
              4+
            </h1>
          ...
          <div className="flex flex-col items-center justify-between text-center h-[184px]">
            ...
            <p className="leading-[32px] font-semibold font-inter">
              Course students
            </p>
          </div>
