...
const Checkout = () => {
  ...
  if (import.meta.env.DEV) console.log("User", user._id);
  const location = useLocation();

  if (import.meta.env.DEV) console.log("selectedCourse", selectedCourse);
  ...
  const handleCheckout = async (data) => {
    ...
    try {
      ...
      const isCompleteProfile = !!firstErrorMessage
        ?.toLowerCase()
        ?.includes("please complete your profile");
      ...
      <div className="flex gap-6 md:mx-[200px] ">
        <div className=" w-1/2 md:mt-[161px]">
          <FormComp
            ...
            fields={fields}
            initialValues={filterdIntialvlues}
            hideButton={true}
        ...
        <div className=" flex-1 mt-[83px] w-[508px] px-[40px]">
          <h3 className="  mb-[57px] font-lato font-bold text-[40px] leading-12 text-center text-[#404040]">
            Complete Payment
          </h3>
