...
import { LayoutDashboard, Mail, Bolt, Receipt } from "lucide-react";
      ...
      <Tabs defaultValue="dashboard" className="py-0">
        ...
        <div className="w-full bg-blue-primary h-[135px] relative flex items-end z-10">
          ...
          <div className="w-full  md:mx-[200px]">
            ...
            <TabsList
              asChild
              className="flex justify-between sm:justify-center w-full h-[76px] bg-white mb-[0.5px] shadow-none ring-0 border-0 rounded-none overflow-x-auto"
            >
